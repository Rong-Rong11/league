...
public class TeamGameFinance {
	...
	private double concessionsRevenue = 0.0;
	private double merchRevenue = 0.0;
	private double tvRevenue = 0.0;
	private double parkingRevenue = 0.0;
	private double arenaCosts = 0.0;
	private double staffCosts = 0.0;
	private double securityCosts = 0.0;
	private double logisticsCosts = 0.0;
	private double travelCosts = 0.0;
