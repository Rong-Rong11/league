...
public class MatchDayListPanel extends JPanel {
	...
	public MatchDayListPanel() {
		...
		gamesColumn.setLayout(new GridLayout(config.SimulationConfiguration.MAX_GAMES_PER_DAY, 1, 0, 0));
	...
	public void showGameDay(GameDay gameDay) {
		...
		for (int i = gameDay.getGames().size(); i < config.SimulationConfiguration.MAX_GAMES_PER_DAY; i++) {
