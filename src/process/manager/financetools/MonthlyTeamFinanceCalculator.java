...
public class MonthlyTeamFinanceCalculator {
    public void applyMonthlyFinance(Team team, int month) {
        ...
        double stadiumMaintenance = calculateStadiumMaintenance(team, marketMultiplier, mediaMarket, economicProfil);
        ...
        FinanceUtilitary.addIncome(budget,
                new Income(FinanceConfiguration.INCOME_TYPE_LOCAL_MERCHANDISING, localMerchandising), month);
        ...
        FinanceUtilitary.addExpense(budget, new Expense(FinanceConfiguration.EXPENSE_TYPE_STAFF_COST, staffCost),
                month);
        FinanceUtilitary.addExpense(budget,
                new Expense(FinanceConfiguration.EXPENSE_TYPE_ADMINISTRATIVE_COST, administrativeCost), month);
