...
public class FinanceConfiguration {
    public static final double INITIAL_LEAGUE_BUDGET = 10500.0;
    public static final int NUMBER_OF_FINANCIAL_MONTHS = 12;
    public static final double LUXURYTAX_THRESHOLD_RATE = 1.2;
    ...
    public static final double MARKET_SIZE_MEDIUM_MULTIPLIER = 1.0;
    public static final double MARKET_SIZE_LARGE_MULTIPLIER = 1.3;
    public static final double BASE_TEAM_BUDGET = 100.0;
    public static final double MAX_BUDGET_TEAM = 350.0;
    public static final double BASE_STADIUM_COSTS = 0.2;
    public static final double BASE_TICKET_PRICE = 100.0;
    ...
    public static final LocalDate PRESEASON_TRADE = LocalDate.of(2026, 8, 1);
    ...
    public static final double LEAGUE_OPERATING_RATE = 0.1;
